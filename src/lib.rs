...
pub mod named {
    ...
    build! {
        ...
        ADD => "<:add:1182128870678335538>",
        ADMIN => "<:admin:1182128872435749005>",
        ANDROID => "<:android:1182128875950592150>",
        ATTACK => "<:attack:1182128880434298900>",
        BOOK_OPEN => "<:book_open:1182128882829242389>",
        BOOK => "<:book:1182128890496438372>",
        BOX => "<:box:1182128897064718386>",
        CANCEL => "<:cancel:1182128899166064720>",
        CHAT => "<:chat:1182128903528124636>",
        COMMAND_ATTACK => "<:command_attack:1182128907856662528>",
        COMMAND_RALLY => "<:command_rally:1182128911082082434>",
        CRAFTING => "<:crafting:1182128916631146566>",
        DIAGONAL => "<:diagonal:1182128919843975290>",
        DISTRIBUTION => "<:distribution:1182128923023261716>",
        DOWN_OPEN => "<:down_open:1182128928031244488>",
        EDIT => "<:edit:1182128933618061352>",
        EFFECT => "<:effect:1182128939150360576>",
        ERASER => "<:eraser:1182128944628113418>",
        EXIT => "<:exit:1182128949497712811>",
        EXPORT => "<:export:1182128954132402257>",
        FILL => "<:fill:1182128958809055372>",
        FILTER => "<:filter:1182128963062091796>",
        FILTERS => "<:filters:1182128967600312381>",
        FLIP_X => "<:flip_x:1182128969743609966>",
        FLIP_Y => "<:flip_y:1182128973673672805>",
        FOLDER => "<:folder:1182128977893142600>",
        GITHUB => "<:github:1182128985820381204>",
        GOOGLE_PLAY => "<:google_play:1182128988064329768>",
        GRID => "<:grid:1182128995509219399>",
        HAMMER => "<:hammer:1182128999351201932>",
        HOST => "<:host:1182129003256107139>",
        INFO_CIRCLE => "<:info_circle:1182129007496548442>",
        ITCHIO => "<:itchio:1182129011950878770>",
        LAYERS => "<:layers:1182129017185378326>",
        LEFT_OPEN => "<:left_open:1182129022906413188>",
        LINE => "<:line:1182129027180404758>",
        LINK => "<:link:1182129032196784199>",
        LIQUID => "<:liquid:1182129034650451969>",
        LOGIC => "<:logic:1182129040212119592>",
        MAP => "<:map:1182129048135155773>",
        MOVE => "<:move:1182129052744687656>",
        NONE => "<:none:1182129058105012325>",
        PASTE => "<:paste:1182129062504841236>",
        PAUSE => "<:pause:1182129067697373298>",
        PENCIL => "<:pencil:1182129072445337692>",
        PLANE => "<:plane:1182129077495287818>",
        PLAY => "<:play:1182129079869251614>",
        PLAYERS => "<:players:1182129203420864557>",
        COPY => "<:copy:1182132924158574592>",
        DEFENSE => "<:defense:1182132929615380510>",
        DOWNLOAD => "<:download:1182132934996656189>",
        EDITOR => "<:editor:1182132940302454784>",
        EYE => "<:eye:1182132944614195332>",
        EYE_OFF => "<:eye_off:1182132947478917150>",
        FILE_TEXT => "<:file_text:1182132951748722790>",
        FILE => "<:file:1182132954382737468>",
        INFO => "<:info:1182132960934252564>",
        LOCK => "<:lock:1182132966705598484>",
        LOCK_OPEN => "<:lock_open:1182132973299048518>",
        PICK => "<:pick:1182132978151866409>",
        PLANET => "<:planet:1182132980899139684>",
        POWER => "<:power:1182132985559003136>",
        PRODUCTION => "<:production:1182132992911613963>",
        PVP => "<:pvp:1182132995130400789>",
        REDDIT => "<:reddit:1182133001044361307>",
        REDO => "<:redo:1182133008384413736>",
        REFRESH => "<:refresh:1182133010586423387>",
        RIGHT_OPEN => "<:right_open:1182133015036575745>",
        ROTATE => "<:rotate:1182133018400399521>",
        SAVE => "<:save:1182133023068655737>",
        SETTINGS => "<:settings:1182133030073151508>",
        SPRAY => "<:spray:1182133032493252689>",
        STEAM => "<:steam:1182133038054912020>",
        SURVIVAL => "<:survival:1182133046233809016>",
        TERMINAL => "<:terminal:1182133050587484231>",
        TRASH => "<:trash:1182133055008284814>",
        TREE => "<:tree:1182133057138987148>",
        TRELLO => "<:trello:1182133061236834375>",
        TURRET => "<:turret:1182133068123873320>",
        UNDO => "<:undo:1182133073454825512>",
        UNITS => "<:units:1182133078022422579>",
        UP_OPEN => "<:up_open:1182133079997960282>",
        UPLOAD => "<:upload:1182133085148561498>",
        WAVES => "<:waves:1182133091570040873>",
        ZOOM => "<:zoom:1182133094090809406>",
        LEFT => "<:left:1182119706392535131>",
        RIGHT => "<:right:1182119750155915264>",
        WARNING => "<:warning:1182119952048726066>",
        UP => "<:up:1182120109221875802>",
        DOWN => "<:down:1182120158072938577>",
        HOME => "<:home:1182120453108670574>",
        OK => "<:ok:1182120559916625971>",
        IMAGE => "<:image:1182120708227223634>",
        STAR => "<:star:1182120776070070382>",
        RESIZE => "<:resize:1182120953245868152>",
        GITHUB_SQUARE => "<:github_square:1182121451655004221>",
        FILE_IMAGE => "<:file_image:1182121569410097252>",
        CHART_BAR => "<:chart_bar:1182121860008259594>",
    }
}
